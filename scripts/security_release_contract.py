...
# base differs from main only in the independently reviewed Alertmanager image
# declaration and its matching source-dependency record. Both that two-file
# base advance and this one-time controller extension are bound by canonical
# digests and exact path allowlists.
...
RECOVERY_POST_EVIDENCE_FIX_CONTROL_DIFF_SHA256 = "sha256:c72ad587afa54660f285153f5c0d29d75cdcf7c09d1508ec6a4ea4533912a791"
