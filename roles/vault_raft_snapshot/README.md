...
work root must remain below it. The test root must not end in `/`, and environment variables do not enable this
exception. This permits direct Molecule and CI-specific ephemeral roots without weakening the path checks.
