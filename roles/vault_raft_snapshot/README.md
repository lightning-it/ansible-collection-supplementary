...
are accepted only for a work root inside the active Molecule temporary directory on a capability-minimized test
controller; production callers must retain the default path and ownership.
